...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default=ROOT / 'models/yolov5s_dh.yaml', help='model.yaml path')
    ...
    parser.add_argument('--resume', nargs='?', const=True, default='/root/yolov5-6.0/runs/model_P4_dh/exp/weights/last.pt', help='resume most recent training')
    ...
    parser.add_argument('--project', default=ROOT / 'runs/model_P4_dh', help='save to project/name')
