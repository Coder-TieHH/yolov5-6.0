...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default=ROOT / 'models/yolov5s_model1_LSK.yaml', help='model.yaml path')
    ...
    parser.add_argument('--project', default=ROOT / 'runs/model_model1_LSK', help='save to project/name')
