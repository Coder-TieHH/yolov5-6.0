...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/root/yolov5-6.0/runs/model_model1_A100/exp/weights/best.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--project', default='/root/yolov5-6.0/runs/model_model1_A100/exp', help='save to project/name')
